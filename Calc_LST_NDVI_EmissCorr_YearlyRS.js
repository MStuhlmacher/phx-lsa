var l8_sr = ee.ImageCollection("LANDSAT/LC08/C01/T1_SR"),
    ...
    patch1985 = ee.FeatureCollection("users/mfstuhlmacher/RioSalado/patch1985_RSrecode"),
    patch1990 = ee.FeatureCollection("users/mfstuhlmacher/RioSalado/patch1990_RSrecode"),
    patch1995 = ee.FeatureCollection("users/mfstuhlmacher/RioSalado/patch1995_RSrecode"),
    patch2000 = ee.FeatureCollection("users/mfstuhlmacher/RioSalado/patch2000_RSrecode"),
    patch2005 = ee.FeatureCollection("users/mfstuhlmacher/RioSalado/patch2005_RSrecode"),
    patch2010 = ee.FeatureCollection("users/mfstuhlmacher/RioSalado/patch2010_RSrecode"),
    sa = ee.FeatureCollection("users/mfstuhlmacher/RioSalado/StudyArea");

//Calculate NDVI and LST for every year (1985-2010) in the comparison site (EE-6A)

//Image dates
// //----1985: 1985-07-23----// //
var day1985 = ee.Image('LANDSAT/LT05/C01/T1_SR/LT05_037037_19850723');//.clip(rs);
...
Export.table.toDrive({
  collection: red1985, 
  description: 'PatchMean_LST_1985_ndviCorrected_RSrecode',
  fileFormat:'CSV'});
...
Export.table.toDrive({
  ...
  description: 'PatchMean_NDVI_1985_RSrecode',
  fileFormat:'CSV'});
...
Export.table.toDrive({
  collection: red1990, 
  description: 'PatchMean_LST_1990_ndviCorrected_RSrecode',
  fileFormat:'CSV'});
...
Export.table.toDrive({
  ...
  description: 'PatchMean_NDVI_1990_RSrecode',
  fileFormat:'CSV'});
...
Export.table.toDrive({
  collection: red1995, 
  description: 'PatchMean_LST_1995_ndviCorrected_RSrecode',
  fileFormat:'CSV'});
...
Export.table.toDrive({
  ...
  description: 'PatchMean_NDVI_1995_RSrecode',
  fileFormat:'CSV'});
...
Export.table.toDrive({
  collection: red2000, 
  description: 'PatchMean_LST_2000_ndviCorrected_RSrecode',
  fileFormat:'CSV'});
...
Export.table.toDrive({
  ...
  description: 'PatchMean_NDVI_2000_RSrecode',
  fileFormat:'CSV'});
...
Export.table.toDrive({
  collection: red2005, 
  description: 'PatchMean_LST_2005_ndviCorrected_RSrecode',
  fileFormat:'CSV'});
...
Export.table.toDrive({
  ...
  description: 'PatchMean_NDVI_2005_RSrecode',
  fileFormat:'CSV'});
...
Export.table.toDrive({
  collection: red2010, 
  description: 'PatchMean_LST_2010_ndviCorrected_RSrecode',
  fileFormat:'CSV'});
...
Export.table.toDrive({
  ...
  description: 'PatchMean_NDVI_2010_RSrecode',
  fileFormat:'CSV'});
