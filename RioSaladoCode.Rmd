...
#plotting vectors
plot(ord.ds,lwd=2,cex=1.7,font=2,border="transparent",bg=c("white","transparent","transparent","transparent"),col=c("darkgoldenrod3","transparent","transparent","darkgoldenrod3"),labels=c("Desert/Soil Size                         ","","","Desert/Soil Distribution                                 "))
plot(ord.veg,lwd=2,cex=1.7,font=2,border="transparent",bg=c("white","transparent","transparent","transparent"),col=c("darkgreen","transparent","transparent","darkgreen"),labels=c("Vegetation Size        ","","","\n\n\nVeg Distribution                 "))
...
plot(ord.bu,lwd=2,cex=1.7,col=c("grey20"),border="transparent",bg=c("transparent","white","transparent","transparent"),font=2,labels=c("                   Built-up Size","Built-up         \nConnectivity          ","Built-up Shape","Built-up Distribution"))
plot(ord.water,lwd=2,cex=1.7,col=c("darkblue"),font=2,labels=c("                  Water Size","Water Connectivity                      ","                      Water Shape","               Water \n               Distribution"))

#bottom arrow showing time
arrows(-0.81,-0.72, 0.83, -0.72, code = 3, lwd = 2, col = 'grey10',lty=2,length=0.1)
arrows(-0.8,-0.72, -0.81, -0.72, code = 2, lwd = 2, col = 'grey10',lty=1,length=0.1)
arrows(0.82,-0.72, 0.83, -0.72, code = 2, lwd = 2, col = 'grey10',lty=1,length=0.1)
text("Earlier Years",x=-0.95,y=-0.72,font=2,cex=1.5)
text("Later Years",x=0.95,y=-0.72,font=2,cex=1.5)
```
